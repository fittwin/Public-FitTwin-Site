      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="5" align="center" bgcolor="#FFFFFF" style="font-family: verdana, arial, helvetica; font-size: small;">
        ...
        <tr valign="top">
          <td>
            ...
            <?php } ?>
            <!-- CUSTOM CODE: Directions for users once they place an order -->
            <p><b><?php echo t('Next Steps:'); ?></b><br />
            <?php echo t('Print this email and bring it with you to the facility for proof of purchase.  If you have a smartphone available you can show the email to the facility upon arrival.  Once you arrive all other paperwork concerning your membership will be completed.'); ?></p>
