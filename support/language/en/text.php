...
$hesklang['accepted_types']='Accepted files';
...
$hesklang['email_noreply']='No reply email';
...
$hesklang['epd']='HESK MESSAGE: email piping is disabled. Enable it in admin settings!';
...
$hesklang['can_view_online']='Can view online staff memebers';
...
$hesklang['sns']='All settings were saved, but SMTP was disabled because of failed SMTP test.';
...
/* DO NOT CHANGE BELOW */
if (!defined('IN_SCRIPT')) {echo "No syntax errors detected in ".htmlspecialchars($_SERVER['PHP_SELF']);exit();}
?>
